...
function morphdom(fromNode, toNode, options) {
    ...
    if (typeof toNode === 'string') {
        toNode = toElement(toNode, fromNode.ownerDocument);
    }
        ...
        if (morphedNodeType === 1) {
            if (toNodeType === 1) {
                if (fromNode.tagName !== toNode.tagName) {
                    ...
                    morphedNode = moveChildren(fromNode, fromNode.ownerDocument.createElement(toNode.tagName));
                }
            } else {
